	...
	return(
		...
		<div id = "about-me">
			...
			<p className = "text-wrap p-10 text-xl text-justify h-screen">
				...
				Driven by my passion for <span className = "text-blue-500">technology</span> & <span className = "text-blue-500">creativity</span>, I’ve taught myself these skills and continue to learn and grow. I’m excited to keep improving and to build a portfolio that showcases my work.
			</p>
